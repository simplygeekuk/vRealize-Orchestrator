/**
 * Returns the value for the parameter '__asd_requestInstanceTypeId'.
 * @author Gavin Stephens <gavin.stephens@simplygeek.co.uk>
 * @version 1.1.0
 * @function getRequestInstanceTypeIdParameterValue
 * @returns {string} Returns the parameter value.
 */

var logType = "Action";
var logName = "getRequestInstanceTypeIdParameterValue"; // This must be set to the name of the action
var Logger = System.getModule("com.simplygeek.library.util").logger(logType, logName);
var log = new Logger(logType, logName);
var parameter = "__asd_requestInstanceTypeId";
var paramValue;
