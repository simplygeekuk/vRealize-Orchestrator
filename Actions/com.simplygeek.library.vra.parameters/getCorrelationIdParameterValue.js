/**
 * Returns the value for the parameter '__asd_correlationId'.
 * @author Gavin Stephens <gavin.stephens@simplygeek.co.uk>
 * @version 1.1.0
 * @function getCorrelationIdParameterValue
 * @returns {string} Returns the parameter value.
 */

var logType = "Action";
var logName = "getCorrelationIdParameterValue"; // This must be set to the name of the action
var Logger = System.getModule("com.simplygeek.library.util").logger(logType, logName);
var log = new Logger(logType, logName);
var parameter = "__asd_correlationId";
var paramValue;
