...
/**
 * Retrieves the value of the 'VMUsedStorageGB' property for the provided vCAC virtual machine entity.
 * @author Gavin Stephens <gavin.stephens@simplygeek.co.uk>
 * @version 1.1.0
 * @function getVMUsedStorageGBForVirtualMachineEntity
 * @param {vCAC:Entity} vcacVmEntity - The vCAC virtual machine entity.
 * @returns {number} Returns the value for the VMUsedStorageGB property.
 */
...
var logType = "Action";
var logName = "getVMUsedStorageGBForVirtualMachineEntity"; // This must be set to the name of the action
var Logger = System.getModule("com.simplygeek.library.util").logger(logType, logName);
var log = new Logger(logType, logName);
var propertyKey = "VMUsedStorageGB";
var propertyValue;
