...
/**
 * Retrieves the value of the 'ExternalReferenceId' (i.e. vm id) property for the provided vCAC virtual machine entity.
 * @author Gavin Stephens <gavin.stephens@simplygeek.co.uk>
 * @version 1.1.0
 * @function getExternalReferenceIdForVirtualMachineEntity
 * @param {vCAC:Entity} vcacVmEntity - The vCAC virtual machine entity.
 * @returns {string} Returns the value for the ExternalReferenceId property.
 */
...
var logType = "Action";
var logName = "getExternalReferenceIdForVirtualMachineEntity"; // This must be set to the name of the action
var Logger = System.getModule("com.simplygeek.library.util").logger(logType, logName);
var log = new Logger(logType, logName);
var propertyKey = "ExternalReferenceId";
var propertyValue;
