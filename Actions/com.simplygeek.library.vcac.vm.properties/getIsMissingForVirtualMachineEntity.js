...
/**
 * Retrieves the value of the 'IsMissing' property for the provided vCAC virtual machine entity.
 * @author Gavin Stephens <gavin.stephens@simplygeek.co.uk>
 * @version 1.1.0
 * @function getIsMissingForVirtualMachineEntity
 * @param {vCAC:Entity} vcacVmEntity - The vCAC virtual machine entity.
 * @returns {boolean} Returns the value for the IsMissing property.
 */
...
var logType = "Action";
var logName = "getIsMissingForVirtualMachineEntity"; // This must be set to the name of the action
var Logger = System.getModule("com.simplygeek.library.util").logger(logType, logName);
var log = new Logger(logType, logName);
var propertyKey = "IsMissing";
var propertyValue;
