...
/**
 * Retrieves the value of the 'GuestOSFamily' property for the provided vCAC virtual machine entity.
 * @author Gavin Stephens <gavin.stephens@simplygeek.co.uk>
 * @version 1.1.0
 * @function getGuestOSFamilyForVirtualMachineEntity
 * @param {vCAC:Entity} vcacVmEntity - The vCAC virtual machine entity.
 * @returns {string} Returns the value for the GuestOSFamily property.
 */
...
var logType = "Action";
var logName = "getGuestOSFamilyForVirtualMachineEntity"; // This must be set to the name of the action
var Logger = System.getModule("com.simplygeek.library.util").logger(logType, logName);
var log = new Logger(logType, logName);
var propertyKey = "GuestOSFamily";
var propertyValue;
