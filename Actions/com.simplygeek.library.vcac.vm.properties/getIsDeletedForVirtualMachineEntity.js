...
/**
 * Retrieves the value of the 'IsDeleted' property for the provided vCAC virtual machine entity.
 * @author Gavin Stephens <gavin.stephens@simplygeek.co.uk>
 * @version 1.1.0
 * @function getIsDeletedForVirtualMachineEntity
 * @param {vCAC:Entity} vcacVmEntity - The vCAC virtual machine entity.
 * @returns {boolean} Returns the value for the IsDeleted property.
 */
...
var logType = "Action";
var logName = "getIsDeletedForVirtualMachineEntity"; // This must be set to the name of the action
var Logger = System.getModule("com.simplygeek.library.util").logger(logType, logName);
var log = new Logger(logType, logName);
var propertyKey = "IsDeleted";
var propertyValue;
