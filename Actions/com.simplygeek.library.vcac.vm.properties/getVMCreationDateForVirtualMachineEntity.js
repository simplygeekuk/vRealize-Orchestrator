...
/**
 * Retrieves the value of the 'VMCreationDate' property for the provided vCAC virtual machine entity.
 * @author Gavin Stephens <gavin.stephens@simplygeek.co.uk>
 * @version 1.1.0
 * @function getVMCreationDateForVirtualMachineEntity
 * @param {vCAC:Entity} vcacVmEntity - The vCAC virtual machine entity.
 * @returns {Date} Returns the value for the VMCreationDate property.
 */
...
var logType = "Action";
var logName = "getVMCreationDateForVirtualMachineEntity"; // This must be set to the name of the action
var Logger = System.getModule("com.simplygeek.library.util").logger(logType, logName);
var log = new Logger(logType, logName);
var propertyKey = "VMCreationDate";
var propertyValue;
