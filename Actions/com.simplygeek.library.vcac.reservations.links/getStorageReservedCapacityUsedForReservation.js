 ...
 * @version 1.0.0
 * @function getStorageReservedCapacityUsedForReservation
 * @param {vCAC:VCACHOST} vcacHost - The vCAC Host.
 * @param {vCAC:Entity} reservationEntity - The vCAC reservation entity.
 * @param {string} storagePath - The storage path.
 * @returns {number} Returns the reserved storage capacity used.
 */
...
var logType = "Action";
var logName = "getStorageReservedCapacityUsedForReservation"; // This must be set to the name of the action
var Logger = System.getModule("com.simplygeek.library.util").logger(logType, logName);
var log = new Logger(logType, logName);
var reservedCapacityUsed = 0;
var reservationName = "";
var reservationId = "";
