...
/**
 * Retrieves the value of the 'HostReservationID' property for the provided vCAC reservation entity.
 * @author Gavin Stephens <gavin.stephens@simplygeek.co.uk>
 * @version 1.0.0
 * @function getReservationIdForReservationEntity
 * @param {vCAC:Entity} reservationEntity - The vCAC reservation entity.
 * @returns {string} Returns the reservation id.
 */
...
var logType = "Action";
var logName = "getReservationIdForReservationEntity"; // This must be set to the name of the action
