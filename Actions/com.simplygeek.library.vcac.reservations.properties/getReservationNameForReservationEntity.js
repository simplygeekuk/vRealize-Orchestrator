...
/**
 * Retrieves the value of the 'HostReservationName' property for the provided vCAC reservation entity.
 * @author Gavin Stephens <gavin.stephens@simplygeek.co.uk>
 * @version 1.0.0
 * @function getReservationNameForReservationEntity
...
var logType = "Action";
var logName = "getReservationNameForReservationEntity"; // This must be set to the name of the action
var Logger = System.getModule("com.simplygeek.library.util").logger(logType, logName);
var log = new Logger(logType, logName);
var propertyKey = "HostReservationName";
var propertyValue;
