...
/**
 * Retrieves the value of the 'ReservationStorageSizeGB' property for the provided vCAC reservation entity.
 * @author Gavin Stephens <gavin.stephens@simplygeek.co.uk>
 * @version 1.0.0
 * @function getReservationStorageSizeGBForReservationEntity
 * @param {vCAC:Entity} reservationEntity - The vCAC reservation entity.
 * @returns {number} Returns the reservation storage size in GB.
 */
...
var logType = "Action";
var logName = "getReservationStorageSizeGBForReservationEntity"; // This must be set to the name of the action
var Logger = System.getModule("com.simplygeek.library.util").logger(logType, logName);
var log = new Logger(logType, logName);
var propertyKey = "ReservationStorageSizeGB";
var propertyValue;
